    ...
    return (
        <Container>
            <form onSubmit={newService}>
                <input placeholder=" Digite novo o nome do Serviço"
                    type="text"
                    value={form.nameService}
                    onChange={(e) => setForm({ ...form, nameService: e.target.value })}
                    required
                />
                <input placeholder="Coloque o link URL da nova foto escolhida"
                    type="url"
                    value={form.photo}
                    onChange={(e) => setForm({ ...form, photo: e.target.value })}
                    required
                />
                <input placeholder=" Coloque a nova descrição"
                    type="text"
                    value={form.description}
                    onChange={(e) => setForm({ ...form, description: e.target.value })}
                    required
                />
                <input placeholder=" Coloque o novo valor do seu serviço "
                    type="number"
                    value={form.price}
